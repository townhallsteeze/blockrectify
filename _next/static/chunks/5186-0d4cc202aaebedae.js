...
//           u = s[1],
//           v = (0, k.LN)().chain,
//           w = (0, k.g0)({ chainId: o.TA }).switchNetwork,
//           x = (0, i.useMemo)(
//             function () {
...
//                       //   children: (0, h.jsxs)(
//                       //     "button",
//                       //     (0, e.Z)((0, d.Z)({ onClick: b, type: "button" }, c), {
...
//                               type: "button",
//                               className:
//                                 "c-rk-ConnectButton bg-[var(--rk-colors-connectButtonBackgroundError)]",
//                               disabled: !0,
...
//                                 (0, h.jsx)("button", {
//                                   className:
//                                     "c-rk-ConnectButton bg-[#030303] !px-[6px] !lg:px-2",
//                                   type: "button",
//                                   disabled: !0,
//                                   children:
//                                     !x &&
...
//                             // onClick: i,
//                             // type: "button",
//                             // className: "c-rk-ConnectButton bg-[var(--blue)]",
...
//           "a",
//           (0, e.Z)(
//             (0, d.Z)({ target: "_blank", rel: "noopener noreferrer" }, c),
//             { children: b }
//           )
//         );
//       }
...
//               })(void 0 === b ? "fast" : b)
//             ),
//             { children: (0, g.jsx)("div", { children: f }) }
//           )
//         );
//       }
//       var s = c(82508),
...
//                 className:
//                   "font-semibold arb-hover hidden items-center whitespace-nowrap rounded-md text-base text-white lg:inline-flex lg:p-1",
//                 children: [
//                   a.children,
//                   (null === (b = a.items) || void 0 === b
//                     ? void 0
//                     : b.length) &&
//                     (0, g.jsx)(u, {
...
//                 className:
//                   "absolute -left-4 z-50 mt-4 w-80 rounded-md bg-white shadow-lg",
//                 children: (0, g.jsx)("div", {
//                   className: "px-6 py-4",
//                   children: a.items.map(function (a, b) {
//                     if (void 0 !== a.anchorProps)
//                       return (0, g.jsx)(
//                         "a",
//                         (0, e.Z)((0, d.Z)({}, a.anchorProps), {
//                           target: "_blank",
//                           rel: "noreferrer",
//                           className:
//                             "-mx-6 block cursor-pointer px-6 py-1 font-semibold hover:bg-blue-arbitrum hover:text-white",
//                           children: a.title,
//                         }),
//                         b
//                       );
...
//                               var d;
//                               return (0,
//                               g.jsx)("a", { href: null === (d = a.anchorProps) || void 0 === d ? void 0 : d.href, target: "_blank", rel: "noreferrer", className: "-mx-6 block py-1 pl-10 pr-6 font-light hover:bg-blue-arbitrum hover:text-white", children: a.title }, "".concat(b, ".").concat(c));
//                             }),
//                           }),
//                         ],
//                       },
...
//                 (0, g.jsxs)(i.p.Button, {
//                   className:
//                     "arb-hover flex w-full items-center justify-start p-4 ".concat(
//                       d && "bg-white"
//                     ),
//                   children: [
//                     (0, g.jsx)("span", {
//                       className:
//                         "flex flex-row flex-nowrap items-center space-x-4 text-2xl font-medium text-white ".concat(
//                           d && "text-blue-arbitrum"
//                         ),
//                       children: a.children,
//                     }),
//                     (null === (c = a.items) || void 0 === c
//                       ? void 0
//                       : c.length) &&
//                       (0, g.jsx)(g.Fragment, {
//                         children: d
//                           ? (0, g.jsx)(v, {
//                               className:
//                                 "ml-2 h-4 w-4 shrink-0 grow-0 text-dark",
//                             })
//                           : (0, g.jsx)(u, {
//                               className:
//                                 "ml-2 h-4 w-4 shrink-0 grow-0 text-white",
//                             }),
//                       }),
//                   ],
//                 }),
...
//                       var c;
//                       return (0,
//                       g.jsx)("li", { className: "w-full px-[4rem] py-2 text-left text-lg font-light text-white !m-0", children: (0, g.jsx)(s.d, { href: null === (c = a.anchorProps) || void 0 === c ? void 0 : c.href, className: "hover:underline focus:underline", children: a.title }) }, b);
//                     }),
//                   }),
//                 }),
//               ],
...
//             return { title: a.title, anchorProps: { href: a.link } };
//           }),
//         };
//       }
//       var C = B([
...
//           },
//           { title: "Developer Docs", link: "https://developer.arbitrum.io" },
//           {
...
//         ]),
//         D = B([
//           { title: "Arbitrum One", link: "https://arbiscan.io" },
//           { title: "Arbitrum Nova", link: "https://nova.arbiscan.io" },
//           { title: "Arbitrum Goerli", link: "https://goerli.arbiscan.io" },
//         ]),
//         E = {
//           Open: function () {
//             return (0, g.jsxs)("svg", {
...
//         return (0, g.jsx)(
//           o(),
//           (0, e.Z)((0, d.Z)({ href: void 0 === c ? "" : c }, h), {
//             legacyBehavior: !0,
//             children: (0, g.jsx)("a", {
//               className:
//                 "arb-hover hidden whitespace-nowrap font-semibold text-base text-white lg:block lg:pr-4",
//               children: b,
//             }),
//           })
//         );
...
//                       (0, g.jsxs)("div", {
//                         className:
//                           "items-center lg:flex lg:space-x-2 xl:space-x-6 ".concat(
//                             void 0 !== l && l ? " !hidden" : ""
//                           ),
//                         children: [
//                           (0, g.jsx)(
//                             w,
//                             (0, e.Z)((0, d.Z)({}, C), { children: "Learn" })
//                           ),
//                           (0, g.jsx)(w, {
//                             items: [
//                               {
...
//                   (0, g.jsxs)("div", {
//                     className:
//                       "items-center justify-end lg:flex lg:space-x-2 xl:space-x-4",
//                     children: [
//                       (0, g.jsx)("div", {
...
//                                 title: "Twitter",
//                                 className:
//                                   "[ l-Header__connect-icon ] [ twitter-icon ]",
...
//                                 title: "Discord",
//                                 className:
//                                   "[ l-Header__connect-icon ] [ discord-icon ]",
...
//                                 title: "Telegram",
//                                 className:
//                                   "[ l-Header__connect-icon ] [ telegram-icon ]",
//                                 children: (0, g.jsx)("svg", {
//                                   xmlns: "http://www.w3.org/2000/svg",
//                                   width: "24.001",
//                                   height: "20",
...
//                                         ? (0, g.jsx)(i.p.Button, {
//                                             className:
//                                               "text-white lg:hidden ml-5 mr-1",
...
//           children: (0, g.jsx)("a", {
//             className:
//               "arb-hover flex w-full flex-row flex-nowrap items-center space-x-4 p-4 py-3 text-2xl font-medium text-white",
//             children: b,
//           }),
//         });
//       }
...
//           children: (0, g.jsx)(m(), { src: b, alt: c, width: 32, height: 32 }),
//         });
//       };
//       function J() {
//         return (0, g.jsx)("div", {
//           className:
//             "absolute left-0 top-[50px] z-50 min-h-screen w-full lg:hidden",
//           children: (0, g.jsxs)("div", {
//             className:
//               "flex min-h-screen flex-col items-center space-y-3 bg-default-black",
//             children: [
//               (0, g.jsx)("div", {
//                 id: "header-content-root",
//                 className:
//                   "flex w-full flex-col-reverse items-center space-y-3",
//               }),
//               (0, g.jsxs)(
//                 x,
//                 (0, e.Z)((0, d.Z)({}, C), {
...
//                   {
//                     title: "Arbitrum Bridge",
//                     anchorProps: { href: "https://bridge.arbitrum.io" },
//                   },
//                 ],
//                 children: [
//                   (0, g.jsx)(I, {
...
//                     (0, g.jsx)("span", {
//                       className:
//                         "bg-[#8d8e8e] flex rounded-full items-center justify-center mr-4",
//                       children: (0, g.jsx)(m(), {
